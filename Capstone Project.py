...
# 
# The analysis for SMOTE method is very similar to the random oversampling method. Again we can see that the ensemble model could get the best parts of all simple models, resulting in a good performance. Once again, tweaking the weigths for each simple model might be a way to enhance the result.
